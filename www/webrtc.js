...
function Session(config) { 
  ...
  exec(onSendMessage, null, 'WebRTCPlugin', 'createSessionObject', [self.sessionKey, config]);
};
...
Session.prototype.call = function (success, error) {
  exec(success, error, 'WebRTCPlugin', 'call', [{
    sessionKey: this.sessionKey
  }]);
};

Session.prototype.receiveMessage = function (data) {
  exec(null, null, 'WebRTCPlugin', 'receiveMessage', [{
    sessionKey: this.sessionKey,
...
Session.prototype.renegotiate = function () {
  exec(null, null, 'WebRTCPlugin', 'renegotiate', [{
    sessionKey: this.sessionKey,
    config: this.config
  }]);
};
...
Session.prototype.close = function () {
  exec(null, null, 'WebRTCPlugin', 'disconnect', [{ 
    sessionKey: this.sessionKey
  }]);
};
...
function setVideoView(config) {
  ...
  exec(null, null, 'WebRTCPlugin', 'setVideoView', [config]);
...
exports.hideVideoView = function () {
  exec(null, null, 'WebRTCPlugin', 'hideVideoView', []);
};

exports.showVideoView = function () {
  exec(null, null, 'WebRTCPlugin', 'showVideoView', []);
};
